...
<%
    ...
    List<Admin> admins =(List<Admin>) (session1.getAttribute("admins"));
            ...
            <div class="card">
                <div class="card-toolbar clearfix">
                    <div class="toolbar-btn-action">
                        <a class="btn btn-success m-r-5" href="adminSearchServlet"><i class="mdi mdi-check"></i> 刷新</a>
                        ...
                        <table class="table table-bordered" id="t_student">
                            ...
                            <c:forEach var="s" items="<%=admins%>">
                                <tr>
                                    <td>
                                        <label class="lyear-checkbox checkbox-primary">
                                            <input type="checkbox" name="ids[]" value="${s.username}"><span></span>
                                        </label>
                                    </td>
                                    <td>${s.username}</td>
                                    <td>${s.password}</td>
                                    <td>
                                        <a class="btn btn-default " href="adminRemoveServlet?userName='${s.username}'" title="删除" data-toggle="tooltip"><i class="mdi mdi-window-close">删除</i></a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
...
<script>
    function delSumCustomer() {
        ...
        console.log(str);
        location.href = "adminRemoveServlet?userName="+str;
    }
</script>
