<%@ page import="com.admin.bean.User" %>
...
<%
    ...
    List<User> users =(List<User>) (session1.getAttribute("users"));
%>
<html lang="zh">
<head>
    <meta charset="utf-8">
            ...
            <div class="card">
                <div class="card-toolbar clearfix">
                    <div class="toolbar-btn-action">
                        <a class="btn btn-success m-r-5" href="userSearchServlet"><i class="mdi mdi-check"></i> 刷新</a>
                    </div>
                </div>
                <div class="card-body">
